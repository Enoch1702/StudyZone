    ...
    <div className="flex min-h-svh flex-col items-center justify-center bg-background px-4 py-8 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-white shadow-xs">
          ...
          <p className="mt-1 text-xs sm:text-sm text-muted">
            Join StudyZone to organize your courses, notes, tasks, and deadlines.
          </p>
        </div>
        ...
        {/* Auth Card */}
        <div className="rounded-xl border border-border bg-surface p-6 sm:p-8 shadow-xs">
