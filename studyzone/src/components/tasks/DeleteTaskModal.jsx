...
export function DeleteTaskModal({ isOpen, onClose, onConfirm, task, loading = false }) {
  useEffect(() => {
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 id="delete-task-title" className="text-base font-semibold text-foreground">
                    Delete Task
                  </h3>
            ...
            <div className="mt-4">
              <p id="delete-task-desc" className="text-sm leading-relaxed text-muted">
                Are you sure you want to delete{' '}
                <span className="font-semibold text-foreground">{task.title}</span>? This task will be
            ...
            <div className="mt-6 flex items-center justify-end gap-3 border-t border-border pt-4">
              ...
              <Button type="button" variant="danger" size="sm" onClick={onConfirm} disabled={loading} className="gap-2">
                {loading ? (<><LoadingSpinner size="sm" /><span>Deleting...</span></>) : (<span>Delete Task</span>)}
              </Button>
            </div>
          </motion.div>
        </motion.div>
