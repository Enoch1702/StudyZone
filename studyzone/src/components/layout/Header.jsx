...
export function Header({ onMenuClick, title }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between gap-4 border-b border-border bg-surface/90 px-4 backdrop-blur-md sm:px-6 lg:px-8">
